<%-- 
    Document   : Template
    Created on : Mar 12, 2023, 4:15:02 PM
    Author     : hp
--%>
...
<table border='0' bgcolor='#000080' align='top' width='100%' style='height:100px'>
    <tr>
        <td bgcolor='#000080' align='center'>
            <font style="font-family: 'Arial Rounded MT Bold', Gadget,sans-serif;" size='+4' color='#FFE4B5'>
            Exotica Travels
            </font>
        </td>
...
<table bgcolor='white' border='0' align='top' width='100%' style="height:470px">
    <tr>
        <td style="width: 216px;" colspan="1" rowspan="4">
            <img src="Images/Sidebar.png" style="width: 215px; height:560px;" alt=''/>
        </td>
